...
export type Drawing = {
  name: string;
  format: "DXF" | "SVG" | "DWG" | "DEMO" | "RASTER";
  unit: string;
...
export function getBounds(primitives: Primitive[]): Bounds {
  const points: Point[] = [];
...
export function measurement(points: Point[]) {
  let length = 0;
...
export function makeZip(files: { name: string; content: string }[]) {
